...
if __name__ == '__main__':
  nums = [1.9, 1.9, 2.0, 2.1, 2.1, 2.2, 2.3, 2.4, 2.4, 2.5, 2.5, 2.5, 2.5, 2.5, 2.6, 2.6, 2.7, 2.7, 2.7, 2.7, 2.7, 2.8, 2.8, 2.9, 2.9, 3.0, 3.0, 3.1, 3.1, 3.4]
  #[23, 27, 29, 30, 31, 32, 32, 33, 34, 34, 35, 35, 35, 36, 37, 37, 38, 39, 39, 40, 40, 41, 42, 42, 42, 43, 43, 44, 44, 45, 45, 46, 46, 46, 47, 47, 48, 48, 49, 50, 51, 51, 52, 54, 56, 57, 59, 59, 63, 69]
  interval = 0.2 
